...
```shell
f1[x_, y_] := 1/(Sqrt[x^2 + y^2] + 0.00001) Tanh[Sqrt[x^2 + y^2]]
f2[x_, y_] := 1/(Sqrt[x^2 + y^2] + 0.00001)
Plot[{f1[x, 0]}, {x, -10, 10}, FrameLabel -> {"|k|", "V(|k|)"}]
Plot[{f2[x, 0]}, {x, -1, 1}, FrameLabel -> {"|k|", "V(|k|)"}]
da1 = Abs[Fourier[Table[f1[x, 0], {x, -10, 10, 0.01}]]];
da2 = Abs[Fourier[Table[f2[x, 0], {x, -10, 10, 0.01}]]];
ListPlot[{da1}, PlotRange -> {{0, 100}, All}, FrameLabel -> {"|r|", "V(|r|)"}]
ListPlot[{da2}, PlotRange -> {{0, 1000}, All}, FrameLabel -> {"|r|", "V(|r|)"}]
```
